...
check_dist_files() {
    ...
    local tarball_file="${dist_dir}/renderkind-${version}.tar.gz"
    local missing_files=()
...
#
# Directory name format: renderkind-test-<PID>-<RANDOM>
...
#
# Full path example:
#   C:\Users\YourName\AppData\Local\Temp\renderkind-test-12345-1234
#
# Returns:
...
create_temp_dir() {
    ...
    local dirname="${base}/renderkind-test-$$-${RANDOM}"
    mkdir -p "${dirname}"
    echo "${dirname}"
}
